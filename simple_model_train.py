...
from util.simple_model_objects import device, data_loader, data_loader_test
...
# checkpoint = torch.load("simple_checkpoint.pth", map_location=device)
...
for epoch in range(start_epoch, num_epochs):
    ...
    if val_loss < best_val_loss:
        ...
        torch.save(train_model.state_dict(), "simple_best_robot_detector.pth")
