import torch
from old_models.simplified_dataset.simple_model.dataset import Dataset
import os
...
ground_truth = []
with open("simple_testing/synthetic_real_limo_dataset/ground_truth_"+DIMENSIONS+".json", "r") as file:
