...
ground_truth = []
with open("synthetic_real_limo_dataset/ground_truth.json", "r") as file:
...
dataset = Dataset(os.path.join(DATA_DIR, 'synthetic_real_limo_dataset/images'), ground_truth)
dataset_test = Dataset(os.path.join(DATA_DIR, 'synthetic_real_limo_dataset/images'), ground_truth)
