...
file_path = '/home/roboticslab/BU-RISE/synthetic_real_limo_dataset/real_limo.png'
...
for i in range(1000):
    ...
    cv2.imwrite(f'synthetic_real_limo_dataset/images/transformed_limo_{i}.jpg', translated_image)

with open("synthetic_real_limo_dataset/ground_truth.json", "w") as file:
