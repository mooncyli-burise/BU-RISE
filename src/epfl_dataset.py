...
class Dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        keypoints = torch.tensor(self.ground_truth[idx]["center"], dtype=torch.float32)
        boxes = torch.tv_tensors([self.ground_truth[idx]["center"][0], self.ground_truth[idx]["center"][1], 16, 16], dtype=torch.float32)
        ...
        headings = torch.tensor([self.ground_truth[idx]["heading"]%360//72], dtype=torch.int64)
        image_id = idx
